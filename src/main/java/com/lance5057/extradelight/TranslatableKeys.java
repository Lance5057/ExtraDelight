...
public class TranslatableKeys {
    public static final String OVEN_SERVED_ON = ExtraDelight.MOD_ID + ".container.oven.served_on";
    public static final String OVEN_CONTAINER = ExtraDelight.MOD_ID + ".container.oven";
