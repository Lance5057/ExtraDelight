...
//		}
	...
	public void render(BakedModel model, PoseStack poseStack, MultiBufferSource bufferSource,
		...
		poseStack.translate(0.001F, -1.0F / 16, -0.001F);
		float scale = 1.002f;
		poseStack.scale(scale, scale, scale);
//		poseStack.mulPose(Axis.YP
//				.rotation((float) (-Math.atan2((double) 2, (double) 1)) - (float) (Math.PI / 2)));
//		poseStack.mulPose(
//				Axis.XP.rotation((float) (-Math.atan2((double) f, (double) 3)) - (float) (Math.PI / 2)));
		...
		drawTop(pos, 1, 1, 1, lightmap, vertexconsumer, matrix4f, matrix3f, copiedQuads);
		drawLip(pos, 1, 1, 1, lightmap, vertexconsumer, matrix4f, matrix3f, copiedQuads);

		poseStack.popPose();
	}

	private void drawTop(BlockPos pos, float h, float w, float l, int lightmap, VertexConsumer vertexconsumer,
			Matrix4f matrix4f, Matrix3f matrix3f, List<BakedQuad> copiedQuads) {
		...
		if (copiedQuads.get(0) != null) {
			...
			// Down
			if (copiedQuads.get(0) != null) {
				u0 = copiedQuads.get(0).getSprite().getU0();
				u1 = copiedQuads.get(0).getSprite().getU1();
				v0 = copiedQuads.get(0).getSprite().getV0();
				v1 = copiedQuads.get(0).getSprite().getV1();
			}

			vertexconsumer.vertex(matrix4f, -1 + 2f / 16f, 0, 1).color(255, 255, 255, 255).uv(u1, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.DOWN.getNormal().getX(), Direction.DOWN.getNormal().getY(),
							Direction.DOWN.getNormal().getZ())
					.endVertex();

			vertexconsumer.vertex(matrix4f, -1 + 2f / 16f, 0, 0).color(255, 255, 255, 255).uv(u1, v0)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.DOWN.getNormal().getX(), Direction.DOWN.getNormal().getY(),
							Direction.DOWN.getNormal().getZ())
					.endVertex();
			vertexconsumer.vertex(matrix4f, 1f / 16f, 0, 0).color(255, 255, 255, 255).uv(u0, v0)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.DOWN.getNormal().getX(), Direction.DOWN.getNormal().getY(),
							Direction.DOWN.getNormal().getZ())
					.endVertex();
			vertexconsumer.vertex(matrix4f, 1f / 16f, 0, 1).color(255, 255, 255, 255).uv(u0, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.DOWN.getNormal().getX(), Direction.DOWN.getNormal().getY(),
							Direction.DOWN.getNormal().getZ())
					.endVertex();
			...
			vertexconsumer.vertex(matrix4f, 1f / 16f, 2f / 16f, 0).color(255, 255, 255, 255).uv(u0 + uUnit * 2, v0)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.NORTH.getNormal().getX(), Direction.NORTH.getNormal().getY(),
							Direction.NORTH.getNormal().getZ())
					.endVertex();

			vertexconsumer.vertex(matrix4f, 1f / 16f, 2f / 16f, 1).color(255, 255, 255, 255).uv(u0 + uUnit * 2, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.NORTH.getNormal().getX(), Direction.NORTH.getNormal().getY(),
							Direction.NORTH.getNormal().getZ())
					.endVertex();
			...
			vertexconsumer.vertex(matrix4f, 1f / 16f, 0, 0).color(255, 255, 255, 255).uv(u0, v0)
					...
					.endVertex();
			vertexconsumer.vertex(matrix4f, -14f / 16, 0, 0).color(255, 255, 255, 255).uv(u0, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.WEST.getNormal().getX(), Direction.WEST.getNormal().getY(),
							Direction.WEST.getNormal().getZ())
					.endVertex();

			vertexconsumer.vertex(matrix4f, -14f / 16, 2f / 16f, 0).color(255, 255, 255, 255).uv(u0 + uUnit * 2, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.WEST.getNormal().getX(), Direction.WEST.getNormal().getY(),
							Direction.WEST.getNormal().getZ())
					.endVertex();
			...
			vertexconsumer.vertex(matrix4f, -14f / 16, 0, 1).color(255, 255, 255, 255).uv(u0, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.EAST.getNormal().getX(), Direction.EAST.getNormal().getY(),
							Direction.EAST.getNormal().getZ())
					.endVertex();

			vertexconsumer.vertex(matrix4f, 1f / 16f, 0, 1).color(255, 255, 255, 255).uv(u0, v0)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.EAST.getNormal().getX(), Direction.EAST.getNormal().getY(),
							Direction.EAST.getNormal().getZ())
					.endVertex();

			vertexconsumer.vertex(matrix4f, 1f / 16f, 2f / 16f, 1).color(255, 255, 255, 255).uv(u0 + uUnit * 2, v0)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.EAST.getNormal().getX(), Direction.EAST.getNormal().getY(),
							Direction.EAST.getNormal().getZ())
					.endVertex();

			vertexconsumer.vertex(matrix4f, -14f / 16, 2f / 16f, 1).color(255, 255, 255, 255).uv(u0 + uUnit * 2, v1)
					.overlayCoords(OverlayTexture.NO_OVERLAY).uv2(lightmap)
					.normal(matrix3f, Direction.EAST.getNormal().getX(), Direction.EAST.getNormal().getY(),
							Direction.EAST.getNormal().getZ())
					.endVertex();
