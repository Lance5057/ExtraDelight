...
public class PotRoastBlock extends FeastBlock
{
	protected static final VoxelShape PLATE_SHAPE = Block.box(1.0D, 0.0D, 1.0D, 14.0D, 2.0D, 14.0D);
	...
	public PotRoastBlock(Properties properties, Supplier<Item> servingItem, boolean hasLeftovers) {
