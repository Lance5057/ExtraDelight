...
public class PatchouliGen extends PatchouliBookProvider {
	...
	public PatchouliGen(PackOutput gen, String modid, String locale,
			CompletableFuture<HolderLookup.Provider> registries) {
		super(gen, modid, locale, registries);
...
//						"This is a WIP, many pages will contain duplicates!", provider)
//				.setBookTexture("patchouli:textures/gui/book_red.png").setModel("extradelight:cookbook")
//				.setUseResourcePack(true).setCreativeTab("extradelight:tab");
//
