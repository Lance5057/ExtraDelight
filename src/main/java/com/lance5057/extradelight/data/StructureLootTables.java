...
public class StructureLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
	...
	public static ResourceLocation feasts = new ResourceLocation(ExtraDelight.MOD_ID, "structures/ingredients");
	...
	public void accept(BiConsumer<ResourceLocation, Builder> t) {
		...
		t.accept(meals,
				LootTable.lootTable().withPool(LootPool.lootPool().name("main").setRolls(UniformGenerator.between(1, 15))
		...
		t.accept(meals,
				LootTable.lootTable().withPool(LootPool.lootPool().name("main").setRolls(UniformGenerator.between(1, 30))
