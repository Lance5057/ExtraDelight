...
public class EDFoods {
	...
	public static final FoodProperties CHEESEBURGER = new FoodProperties.Builder().nutrition(15).saturationModifier(0.6f).effect(COMFORT_BRIEF, 1F).effect(PICKLED_ONE, 1F).build();
	public static final FoodProperties BACON_CHEESEBURGER = new FoodProperties.Builder().nutrition(19).saturationModifier(0.7f).effect(COMFORT_MEDIUM, 1F).effect(PICKLED_ONE, 1F).build();
	...
	public static final FoodProperties CHARCUTERIE = new FoodProperties.Builder().nutrition(4).saturationModifier(0.11f).effect(NOURISHMENT_BRIEF, 1F).usingConvertsTo(Items.BOWL).alwaysEdible().build();
	...
	public static final FoodProperties JALAPENO_STUFFED_POTATO = new FoodProperties.Builder().nutrition(13).saturationModifier(0.65f).effect(COMFORT_MEDIUM, 1F).effect(FIRE_RESISTANCE_MEDIUM, 1F).build();
	...
	public static final FoodProperties CHILI_CHEESE_CORNBREAD_MUFFIN = new FoodProperties.Builder().nutrition(3).saturationModifier(0.12f).effect(FIRE_RESISTANCE_SHORT, 1F).effect(NOURISHMENT_BRIEF, 1F).build();
	public static final FoodProperties CHILI_CON_CARNE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.13f).effect(NOURISHMENT_MEDIUM, 1F).effect(FIRE_RESISTANCE_LONG, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties WHITE_CHILI = new FoodProperties.Builder().nutrition(5).saturationModifier(0.12f).effect(NOURISHMENT_LONG, 1F).effect(FIRE_RESISTANCE_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties HAZELNUT_SOUP = new FoodProperties.Builder().nutrition(7).saturationModifier(0.21f).effect(NOURISHMENT_MEDIUM, 1F).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties FRENCH_ONION_SOUP = new FoodProperties.Builder().nutrition(7).saturationModifier(0.16f).effect(NOURISHMENT_MEDIUM, 1F).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties BACON_EGG_PIE = new FoodProperties.Builder().nutrition(4).saturationModifier(0.08f).effect(NOURISHMENT_MEDIUM, 1F).effect(COMFORT_BRIEF, 1F).build();
	...
	public static final FoodProperties BORSCHT = new FoodProperties.Builder().nutrition(5).saturationModifier(0.13f).effect(COMFORT_MEDIUM, 1F).effect(NOURISHMENT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties CHICKEN_KIEV = new FoodProperties.Builder().nutrition(8).saturationModifier(0.24f).effect(COMFORT_MEDIUM, 1F).effect(NOURISHMENT_BRIEF, 1F).build();
	public static final FoodProperties BRUSCETTA = new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).effect(COMFORT_BRIEF, 1F).effect(NOURISHMENT_MEDIUM, 1F).build();
	public static final FoodProperties DEVILLED_SAUSAGES = new FoodProperties.Builder().nutrition(10).saturationModifier(0.22f).effect(COMFORT_MEDIUM, 1F).effect(NOURISHMENT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties AGLIO_E_OLIO = new FoodProperties.Builder().nutrition(11).saturationModifier(0.42f).effect(COMFORT_MEDIUM, 1F).effect(NOURISHMENT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties PENNE_ALL_ARRABBIATA = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).effect(COMFORT_BRIEF, 1F).effect(NOURISHMENT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties CUCUMBER = new FoodProperties.Builder().nutrition(2).saturationModifier(0.6f).build();
	public static final FoodProperties SOYBEANS = new FoodProperties.Builder().nutrition(1).saturationModifier(0.2f).build();
	public static final FoodProperties GHERKINS = new FoodProperties.Builder().nutrition(6).saturationModifier(0.6f).effect(PICKLED_ONE, 1F).build();
	...
	public static final FoodProperties PICKLED_SAUSAGE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.2f).effect(PICKLED_TWO, 1F).build();
	public static final FoodProperties SOY_SAUCE = new FoodProperties.Builder().nutrition(7).saturationModifier(0.25f).usingConvertsTo(Items.GLASS_BOTTLE).build();
	...
	public static final FoodProperties KIMCHI = new FoodProperties.Builder().nutrition(4).saturationModifier(0.21f).effect(PICKLED_TWO, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties HOT_SAUCE = new FoodProperties.Builder().nutrition(1).saturationModifier(0.13f).effect(FIRE_RESISTANCE_SHORT, 1F).usingConvertsTo(Items.GLASS_BOTTLE).build();
	public static final FoodProperties MISO_PASTE = new FoodProperties.Builder().nutrition(5).saturationModifier(0.05f).usingConvertsTo(Items.GLASS_BOTTLE).build();
	public static final FoodProperties NATTO = new FoodProperties.Builder().nutrition(5).saturationModifier(0.2f).effect(ROT, 0.05F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties SALAMI_MIX = new FoodProperties.Builder().nutrition(0).saturationModifier(0.05f).effect(HUNGER, 1F).build();
	public static final FoodProperties UNRIPE_SALAMI = new FoodProperties.Builder().nutrition(0).saturationModifier(0.05f).effect(HUNGER, 1F).build();
	public static final FoodProperties SALAMI = new FoodProperties.Builder().nutrition(4).saturationModifier(0.05f).effect(NOURISHMENT_MEDIUM, 1F).build();
	public static final FoodProperties COOKED_SOYBEANS = new FoodProperties.Builder().nutrition(5).saturationModifier(0.2f).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties NAEM_MOO = new FoodProperties.Builder().nutrition(7).saturationModifier(0.3f).effect(PICKLED_FOUR, 1F).build();
	public static final FoodProperties GAZPACHO = new FoodProperties.Builder().nutrition(8).saturationModifier(0.5f).effect(COMFORT_BRIEF, 1F).effect(NOURISHMENT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties EDAMAME = new FoodProperties.Builder().nutrition(5).saturationModifier(0.2f).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties BEEF_BULGOGI = new FoodProperties.Builder().nutrition(8).saturationModifier(0.19f).effect(COMFORT_LONG, 1F).effect(NOURISHMENT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties HONEY_CHILI_CHICKEN = new FoodProperties.Builder().nutrition(10).saturationModifier(0.16f).effect(NOURISHMENT_LONG, 1F).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties CARAMEL_CHICKEN = new FoodProperties.Builder().nutrition(7).saturationModifier(0.15f).effect(NOURISHMENT_LONG, 1F).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties SOY_GLAZED_SALMON = new FoodProperties.Builder().nutrition(4).saturationModifier(0.06f).effect(COMFORT_LONG, 1F).effect(NOURISHMENT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties STEAK_PICKLED_ONION_PIE_SLICE = new FoodProperties.Builder().nutrition(4).saturationModifier(0.12f).effect(COMFORT_LONG, 1F).effect(NOURISHMENT_MEDIUM, 1F).build();
	public static final FoodProperties KIWIBURGER = new FoodProperties.Builder().nutrition(16).saturationModifier(0.6f).effect(REGENERATION_BRIEF, 1F).effect(COMFORT_LONG, 1F).build();
	public static final FoodProperties SHIRAZI_SALAD = new FoodProperties.Builder().nutrition(6).saturationModifier(0.37f).effect(NOURISHMENT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties CUCUMBER_SALAD = new FoodProperties.Builder().nutrition(6).saturationModifier(0.17f).effect(NOURISHMENT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties MISO_SOUP = new FoodProperties.Builder().nutrition(8).saturationModifier(0.18f).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties NATTO_AND_RICE = new FoodProperties.Builder().nutrition(11).saturationModifier(0.3f).effect(ROT, 0.05F).effect(COMFORT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties SAUERKRAUT_SOUP = new FoodProperties.Builder().nutrition(6).saturationModifier(0.15f).effect(PICKLED_THREE, 1F).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties SAUERKRAUT_AND_SAUSAGE = new FoodProperties.Builder().nutrition(9).saturationModifier(0.14f).effect(PICKLED_THREE, 1F).effect(COMFORT_BRIEF, 1F).effect(NOURISHMENT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties CHEESYMITE_SCROLL_SERVING = new FoodProperties.Builder().nutrition(4).saturationModifier(0.09f).effect(REGENERATION_BRIEF, 1F).effect(COMFORT_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties MORKOVCHA = new FoodProperties.Builder().nutrition(3).saturationModifier(0.16f).effect(NOURISHMENT_MEDIUM, 1F).effect(PICKLED_ONE, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties ZUPA_OGORKOWA = new FoodProperties.Builder().nutrition(6).saturationModifier(0.17f).effect(PICKLED_FOUR, 1F).effect(COMFORT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties KIMCHI_FRIED_RICE = new FoodProperties.Builder().nutrition(9).saturationModifier(0.13f).effect(PICKLED_THREE, 1F).effect(COMFORT_BRIEF, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties KONGJANG = new FoodProperties.Builder().nutrition(5).saturationModifier(0.13f).effect(DAMAGE_RESISTANCE_MEDIUM, 1F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties CHEESEBURGER_PICKLE = new FoodProperties.Builder().nutrition(5).saturationModifier(0.17f).effect(COMFORT_MEDIUM, 1F).effect(NOURISHMENT_MEDIUM, 1F).effect(PICKLED_TWO, 1F).build();
	public static final FoodProperties HOT_WINGS = new FoodProperties.Builder().nutrition(5).saturationModifier(0.31f).effect(FIRE_RESISTANCE_MEDIUM, 1F).effect(COMFORT_MEDIUM, 0F).usingConvertsTo(Items.GLASS_BOTTLE).build();
