...
//			() -> new YeastPotBlock(ExtraDelightItems.VINEGAR, 8));
	// public static final DeferredBlock<Block> GRATER = BLOCKS.register("grater",
	// GraterBlock::new);

//	public static final DeferredBlock<Block> MORTAR_STONE = BLOCKS.register("mortar_stone", MortarBlock::new);
//	public static final DeferredBlock<Block> MORTAR_ANDESITE = BLOCKS.register("mortar_andesite", MortarBlock::new);
//	public static final DeferredBlock<Block> MORTAR_GRANITE = BLOCKS.register("mortar_granite", MortarBlock::new);
//	public static final DeferredBlock<Block> MORTAR_DIORITE = BLOCKS.register("mortar_diorite", MortarBlock::new);
//	public static final DeferredBlock<Block> MORTAR_DEEPSLATE = BLOCKS.register("mortar_deepslate",
//			() -> new MortarBlock(SoundType.DEEPSLATE));
//	public static final DeferredBlock<Block> MORTAR_BLACKSTONE = BLOCKS.register("mortar_blackstone", MortarBlock::new);
//	public static final DeferredBlock<Block> MORTAR_BASALT = BLOCKS.register("mortar_basalt",
//			() -> new MortarBlock(SoundType.BASALT));
//	public static final DeferredBlock<Block> MORTAR_ENDSTONE = BLOCKS.register("mortar_endstone", MortarBlock::new);
//
//	// not craftable, dungeon items
//	public static final DeferredBlock<Block> MORTAR_AMETHYST = BLOCKS.register("mortar_amethyst",
//			() -> new MortarBlock(SoundType.AMETHYST));
//	public static final DeferredBlock<Block> MORTAR_GILDED_BLACKSTONE = BLOCKS.register("mortar_gilded_blackstone",
...
//	public static final DeferredBlock<Block> GLOW_BERRY_CHEESECAKE = ExtraDelightBlocks.BLOCKS.register(
//			"glow_berry_cheesecake",
//			() -> new PieBlock(Block.Properties.ofFullCopy(Blocks.CAKE), ExtraDelightItems.GLOW_BERRY_CHEESECAKE_SLICE));
//
//	public static final DeferredBlock<Block> PLAIN_CAKE = ExtraDelightBlocks.BLOCKS.register("plain_cake",
...
//			() -> new RecipeFeastBlock(Block.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.COLOR_BROWN), true,
//					bowl));
...
//			() -> new JellyBlock(Block.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE),
...
//			() -> new JellyBlock(Block.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.TERRACOTTA_LIGHT_GREEN),
...
//
//	// Used to use:
//	// BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS, MapColor.COLOR_BROWN)
...
//			() -> new RecipeFeastBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.METAL).strength(0.8F)
...
//			() -> new RecipeFeastBlock(Block.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.COLOR_GREEN), true,
//					bowl));
//
////Halloween Start
...
//			() -> new RecipeFeastBlock(Block.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.COLOR_YELLOW), true,
//					bowl));
//
...
//			() -> new RecipeFeastBlock(Block.Properties.ofFullCopy(Blocks.WHITE_WOOL).mapColor(MapColor.COLOR_BROWN), false,
//					pan));
//
...
//			() -> new FenceGateBlock(Block.Properties.ofFullCopy(Blocks.ACACIA_FENCE_GATE)));
...
//			() -> new DoorBlock(Block.Properties.ofFullCopy(Blocks.ACACIA_DOOR)));
//	public static final DeferredBlock<TrapDoorBlock> CINNAMON_TRAPDOOR = BLOCKS.register("cinnamon_trapdoor",
//			() -> new TrapDoorBlock(Block.Properties.ofFullCopy(Blocks.ACACIA_TRAPDOOR)));
