package com.lance5057.extradelight.workstations.chiller.inventory;
...
public class ChillerItemHandler implements IItemHandler {
	...
	public ChillerItemHandler(IItemHandler itemHandler, @Nullable Direction side) {
