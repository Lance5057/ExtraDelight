...
public class OvenRecipe implements Recipe<RecipeWrapper> {
    ...
    public OvenRecipe(ResourceLocation id, String group, NonNullList<Ingredient> inputItems, ItemStack output,
...
//				}
                ...
                return new OvenRecipe(recipeId, groupIn, inputItemsIn, outputIn, container, experienceIn, cookTimeIn);
            }
        }
