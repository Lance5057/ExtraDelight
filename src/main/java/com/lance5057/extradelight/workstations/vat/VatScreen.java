...
public class VatScreen extends AbstractContainerScreen<VatMenu> {
	...
	public void init() {
		super.init();
		addRenderableOnly(new FluidStackWidget(this.leftPos + 41, this.topPos - 4, 16, 71, menu::getFluidTank));
	}
	...
	protected void renderBg(GuiGraphics graphics, float pPartialTick, int pMouseX, int pMouseY) {
		...
		if (this.menu.tileEntity.curRecipe != null)
			...
			graphics.drawString(this.font, "0", this.leftPos + 145, this.topPos + 14, 4210752, false);
	}
