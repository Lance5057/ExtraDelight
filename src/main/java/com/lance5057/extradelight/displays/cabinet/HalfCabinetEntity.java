...
//
//public class HalfCabinetEntity extends RandomizableContainerBlockEntity {
//
//	private NonNullList<ItemStack> contents = NonNullList.withSize(18, ItemStack.EMPTY);
//	private ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
//		protected void onOpen(Level level, BlockPos pos, BlockState state) {
//			HalfCabinetEntity.this.playSound(state, ModSounds.BLOCK_CABINET_OPEN.get());
//			HalfCabinetEntity.this.updateBlockState(state, true);
//		}
//
//		protected void onClose(Level level, BlockPos pos, BlockState state) {
//			HalfCabinetEntity.this.playSound(state, ModSounds.BLOCK_CABINET_CLOSE.get());
//			HalfCabinetEntity.this.updateBlockState(state, false);
//		}
//
...
//				return container == HalfCabinetEntity.this;
//			} else {
//				return false;
//			}
//		}
//	};
//
//	public HalfCabinetEntity(BlockPos pos, BlockState state) {
//		super(ExtraDelightBlockEntities.HALF_CABINET.get(), pos, state);
//	}
//
//	@Override
