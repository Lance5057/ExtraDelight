...
public class DynamicNameCampfireRecipe extends CampfireCookingRecipe {
	...
	public DynamicNameCampfireRecipe(ResourceLocation pId, String pGroup, Ingredient pIngredient, ItemStack pResult,
	...
	public static class Serializer implements RecipeSerializer<DynamicNameCampfireRecipe> {
		public DynamicNameCampfireRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
			...
			return new DynamicNameCampfireRecipe(pRecipeId, s, ingredient, itemstack, f, i);
		}

		public DynamicNameCampfireRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
