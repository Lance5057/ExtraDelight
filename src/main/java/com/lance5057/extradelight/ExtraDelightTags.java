...
public class ExtraDelightTags {
	...
	// Storage Blocks
		...
		public static final TagKey<Block> STORAGE_BLOCKS_DRIED_CORN_HUSK = neoforgeBlockTag("storage_blocks_dried_corn_husk");
		...
		public static final TagKey<Block> STORAGE_BLOCKS_GROUND_CINNAMON = neoforgeBlockTag("storage_blocks_ground_cinnamon");
		...
		public static final TagKey<Block> STORAGE_BLOCKS_BLOOD_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_blood_chocolate_bar");
		public static final TagKey<Block> STORAGE_BLOCKS_DARK_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_dark_chocolate_bar");
		public static final TagKey<Block> STORAGE_BLOCKS_MILK_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_milk_chocolate_bar");
		public static final TagKey<Block> STORAGE_BLOCKS_WHITE_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_white_chocolate_bar");
		...
		public static final TagKey<Block> STORAGE_BLOCKS_PEANUTS_IN_SHELL = neoforgeBlockTag("storage_blocks_peanuts_in_shell");
		public static final TagKey<Block> STORAGE_BLOCKS_PEANUTS = neoforgeBlockTag("storage_blocks_peanuts");
		public static final TagKey<Block> STORAGE_BLOCKS_ROASTED_PEANUTS = neoforgeBlockTag("storage_blocks_roasted_peanuts");
		public static final TagKey<Block> STORAGE_BLOCKS_HAZELNUTS_IN_SHELL = neoforgeBlockTag("storage_blocks_hazelnuts_in_shell");
		public static final TagKey<Block> STORAGE_BLOCKS_HAZELNUTS = neoforgeBlockTag("storage_blocks_hazelnuts");
		public static final TagKey<Block> STORAGE_BLOCKS_ROASTED_HAZELNUTS = neoforgeBlockTag("storage_blocks_roasted_hazelnuts");
		...
		public static final TagKey<Block> STORAGE_BLOCKS_COFFEE_CHERRIES = neoforgeBlockTag("storage_blocks_coffee_cherries");
		...
		public static final TagKey<Block> STORAGE_BLOCKS_ROASTED_COCOA_BEANS = neoforgeBlockTag("storage_blocks_roasted_cocoa_beans");
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_FLOUR = neoforgeBlockTag("storage_blocks_flour");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CORN_MEAL = neoforgeBlockTag("storage_blocks_corn_meal");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_SUGAR = neoforgeBlockTag("storage_blocks_sugar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CORN_ON_COB = neoforgeBlockTag("storage_blocks_corn_on_cob");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CORN_HUSK = neoforgeBlockTag("storage_blocks_corn_husk");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_DRIED_CORN_HUSK = neoforgeBlockTag("storage_blocks_dried_corn_husk");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CORN_COB = neoforgeBlockTag("storage_blocks_corn_cob");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GINGER = neoforgeBlockTag("storage_blocks_ginger");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_EGGS = neoforgeBlockTag("storage_blocks_eggs");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_APPLE = neoforgeBlockTag("storage_blocks_apple");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GOLDEN_APPLE = neoforgeBlockTag("storage_blocks_golden_apple");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_BROWN_MUSHROOM = neoforgeBlockTag("storage_blocks_brown_mushroom");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_RED_MUSHROOM = neoforgeBlockTag("storage_blocks_red_mushroom");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_SWEET_BERRIES = neoforgeBlockTag("storage_blocks_sweet_berries");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GLOW_BERRIES = neoforgeBlockTag("storage_blocks_glow_berries");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CORN_SILK = neoforgeBlockTag("storage_blocks_corn_silk");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GROUND_CINNAMON = neoforgeBlockTag("storage_blocks_ground_cinnamon");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_RAW_CINNAMON = neoforgeBlockTag("storage_blocks_raw_cinnamon");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CINNAMON_STICK = neoforgeBlockTag("storage_blocks_cinnamon_stick");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_BREAD_CRUMBS = neoforgeBlockTag("storage_blocks_bread_crumbs");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MINT = neoforgeBlockTag("storage_blocks_mint");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MARSHMALLOW = neoforgeBlockTag("storage_blocks_marshmallow");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GOLDEN_CARROT = neoforgeBlockTag("storage_blocks_golden_carrot");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_BLOOD_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_blood_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_DARK_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_dark_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MILK_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_milk_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_WHITE_CHOCOLATE_BAR = neoforgeBlockTag("storage_blocks_white_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CHILI = neoforgeBlockTag("storage_blocks_chili");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CHILI_POWDER = neoforgeBlockTag("storage_blocks_chili_powder");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_PEANUTS_IN_SHELL = neoforgeBlockTag("storage_blocks_peanuts_in_shell");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_PEANUTS = neoforgeBlockTag("storage_blocks_peanuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_ROASTED_PEANUTS = neoforgeBlockTag("storage_blocks_roasted_peanuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_HAZELNUTS_IN_SHELL = neoforgeBlockTag("storage_blocks_hazelnuts_in_shell");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_HAZELNUTS = neoforgeBlockTag("storage_blocks_hazelnuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_ROASTED_HAZELNUTS = neoforgeBlockTag("storage_blocks_roasted_hazelnuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MALLOW_ROOT = neoforgeBlockTag("storage_blocks_mallow_root");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MALLOW_POWDER = neoforgeBlockTag("storage_blocks_mallow_powder");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COFFEE_CHERRIES = neoforgeBlockTag("storage_blocks_coffee_cherries");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GREEN_COFFEE = neoforgeBlockTag("storage_blocks_green_coffee");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COFFEE_BEANS = neoforgeBlockTag("storage_blocks_coffee_beans");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GROUND_COFFEE = neoforgeBlockTag("storage_blocks_ground_coffee");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COCOA_BEANS = neoforgeBlockTag("storage_blocks_cocoa_beans");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_ROASTED_COCOA_BEANS = neoforgeBlockTag("storage_blocks_roasted_cocoa_beans");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COCOA_SOLIDS = neoforgeBlockTag("storage_blocks_cocoa_solids");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COCOA_POWDER = neoforgeBlockTag("storage_blocks_cocoa_powder");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CORN_KERNELS = neoforgeBlockTag("storage_blocks_corn_kernels");
} 
