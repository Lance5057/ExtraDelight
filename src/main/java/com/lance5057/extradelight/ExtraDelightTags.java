...
public class ExtraDelightTags {
	...
	// Storage Blocks
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_DRIED_CORN_HUSK = neoforgeItemTag("storage_blocks_dried_corn_husk");
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_BROWN_MUSHROOM = neoforgeItemTag("storage_blocks_brown_mushroom");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_RED_MUSHROOM = neoforgeItemTag("storage_blocks_red_mushroom");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_SWEET_BERRIES = neoforgeItemTag("storage_blocks_sweet_berries");
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GROUND_CINNAMON = neoforgeItemTag("storage_blocks_ground_cinnamon");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_RAW_CINNAMON = neoforgeItemTag("storage_blocks_raw_cinnamon");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_CINNAMON_STICK = neoforgeItemTag("storage_blocks_cinnamon_stick");
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GOLDEN_CARROT = neoforgeItemTag("storage_blocks_golden_carrot");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_BLOOD_CHOCOLATE_BAR = neoforgeItemTag("storage_blocks_blood_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_DARK_CHOCOLATE_BAR = neoforgeItemTag("storage_blocks_dark_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MILK_CHOCOLATE_BAR = neoforgeItemTag("storage_blocks_milk_chocolate_bar");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_WHITE_CHOCOLATE_BAR = neoforgeItemTag("storage_blocks_white_chocolate_bar");
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_PEANUTS_IN_SHELL = neoforgeItemTag("storage_blocks_peanuts_in_shell");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_PEANUTS = neoforgeItemTag("storage_blocks_peanuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_ROASTED_PEANUTS = neoforgeItemTag("storage_blocks_roasted_peanuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_HAZELNUTS_IN_SHELL = neoforgeItemTag("storage_blocks_hazelnuts_in_shell");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_HAZELNUTS = neoforgeItemTag("storage_blocks_hazelnuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_ROASTED_HAZELNUTS = neoforgeItemTag("storage_blocks_roasted_hazelnuts");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MALLOW_ROOT = neoforgeItemTag("storage_blocks_mallow_root");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_MALLOW_POWDER = neoforgeItemTag("storage_blocks_mallow_powder");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COFFEE_CHERRIES = neoforgeItemTag("storage_blocks_coffee_cherries");
		...
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_GROUND_COFFEE = neoforgeItemTag("storage_blocks_ground_coffee");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_COCOA_BEANS = neoforgeItemTag("storage_blocks_cocoa_beans");
		public static final TagKey<Item> STORAGE_BLOCKS_ITEM_ROASTED_COCOA_BEANS = neoforgeItemTag("storage_blocks_roasted_cocoa_beans");
